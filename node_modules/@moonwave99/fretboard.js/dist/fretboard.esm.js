...
import { chroma, get as get$2, transpose } from '@tonaljs/note';
import { semitones, distance, get as get$3 } from '@tonaljs/interval';
import { get as get$1 } from '@tonaljs/scale';
import { get } from '@tonaljs/mode';
...
class Fretboard {
    ...
    render() {
        const { wrapper, positions, dots } = this;
    ...
    on(eventName, handler) {
        ...
        this.handlers[eventName] = throttle(THROTTLE_INTERVAL, (event) => {
            ...
            handler(Object.assign(Object.assign({}, position), { note }), event);
        });
...
})(TetrachordTypes || (TetrachordTypes = {}));
var TetrachordLayouts;
...
})(TetrachordLayouts || (TetrachordLayouts = {}));
const Tetrachords = {
...
export { Fretboard, FretboardSystem, GUITAR_TUNINGS, Systems, TetrachordLayouts, TetrachordTypes, disableDots, disableStrings, sliceBox, tetrachord };
//# sourceMappingURL=fretboard.esm.js.map
